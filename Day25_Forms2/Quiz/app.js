...
function RandomQuestion(){
    ...
    //   swap the selected question with the last question in the array and reduce the length of the array by 1
...
submitButton.className = "submit-btn button";
submitButton.innerText = "SUBMIT";

const resetButton = document.createElement('button');
resetButton.type = 'reset';
resetButton.className = "reset-btn button";
