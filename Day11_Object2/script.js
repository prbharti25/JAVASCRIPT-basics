...
const user2= Object.assign({},user);    //creates a copy (shallow copy: for nested objects/deep copy: for normal or outer objects)     Assign and spread operator works same while copying objects

// it creates a new object for the user2 containing outer object but nested object for both user and user2 refer to the same address{----}

user2.name="Pushp";     //no change in user
user2.address.city="Bokaro";  //changes to both user and user2 (both share common address since address is nested object)
// console.log(user2, user);

// user2.address.pin=123446;   //nested object --> creates shallow copy
// user2.name="Pushp";     //deep copy for the normal objects without nested objects 
...
// const {name, age,...obj1}=obj;    //Except name and age all other key value pairs are stored into obj1 from obj (rest operator--> (...) ...obj1)
...
// const [first, fourth, ...arr2]=arr;
// console.log(first, fourth, arr2);
...
console.log(userX.greet());
console.log(userX.meet());
...
// console.log(objX.name, objX.amount); 
console.log(objX.toString());    //i have never made that function(toString()) but i am able to use that
